...
of this type are constructed via either "Right :: Int -> Either E Int" or "Left
:: E -> Either E Int". In particular, any invocation of a function returning
...
1) predictable control flow and 2) forcing the caller to deal with any
exceptional conditions. A function "either" can be defined which takes a handler
...
or Right, but 1) modern CPUs have branch prediction that might be able to deal
with this and 2) does it matter if the solution is this elegant?
