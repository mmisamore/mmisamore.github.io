...
tags: [existential quantification, existential antipattern]
---
...
Defining a rendering function like
    ...
    > let renderAll :: forall a. (Render a) => [a] -> IO (); renderAll = mapM_ render
...
Finally we can write the generic renderAll function:
    ...
    > let renderAll :: [Renderable] -> IO (); renderAll = sequenceA_ . map render 
...
able to provide us with a list of Renderables:
    ...
    > let gameRenderables :: Game -> [Renderable]; gameRenderables = -- ...
...
new Renderable. For example:
    ...
    > let listRend :: [Renderable] -> Renderable; listRend = Renderable . mapM_ render
