...
of intermediate resultsets to verify data quality and code correctness,
...
tables or table variables to store intermediate resultsets, but have
...
queries from modest starting resultsets, adding more information with
...
*always* generated at least one (possibly NULL) tuple in the resultsets
